...
export default function RegionSitesPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      >
        <h1 className="text-3xl font-bold text-center">{region}のサイト選択</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-5xl mx-auto">
            {sites.map((site) => {
              ...
              return (
                <Link
                  key={site}
                  href={`/regions/${encodeURIComponent(region)}/${encodeURIComponent(site)}`}
